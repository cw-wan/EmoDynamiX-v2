<p align="center">
  ...
  <h4 align="center"><img src="img/acl-logo.png" alt="ACL Logo" style="height:1em; vertical-align:middle;"> NAACL 2025 <i>Oral</i></h4>
  <p align="center">  
  ...
  <span style="font-size: 60%;">* <i>Poster presented at <a href="https://coria-taln-2025.lis-lab.fr/articles-acceptes/">CORIA-TALN 2025</a>.</i></span>
</p>
...
EmoDynamiX is a strong, lightweight baseline for Emotional Support Conversation. According to a comprehensive benchmark on diverse dialog metrics ([AFlow](https://arxiv.org/abs/2602.08826), 2026), EmoDynamiX is the best in the Strategy & Knowledge model category, while outperforming task- and interpretability-oriented ESC systems. It is also competitive against strong, heavier baselines like Social Simulation, Multi-agent ESC, Value Reinforce, and proprietary LLM baselines (GPT-4o and Claude-3.5).
